...
<head>
  ...
  <link href="<?= base_url(''); ?>/home/assets/favicon.ico" rel="icon">
  ...
  <link href="<?= base_url(''); ?>/home/main.550dcf66.css" rel="stylesheet">
</head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?= base_url(''); ?>/login" title="">Login</a></li>
          ...
          <div id="carousel-example-generic" class="carousel carousel-fade slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <div class="item active">
                <img class="img-responsive" src="<?= base_url(''); ?>/home/assets/images/img-06.jpg" alt="First slide">
              ...
              <div class="item">
                <img class="img-responsive" src="<?= base_url(''); ?>/home/assets/images/img-07.jpg" alt="First slide">
                <div class="carousel-caption card-shadow reveal">
  ...
  <div class="section-container">
    <div class="container text-center">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
          <img src="<?= base_url(''); ?>/home/assets/images/logo-02.png" alt="" class="img-responsive reveal-content image-center">
        </div>
        <div class="col-xs-12 col-md-4">
          <img src="<?= base_url(''); ?>/home/assets/images/logo-03.png" alt="" class="img-responsive reveal-content image-center">
        </div>
      </div>
    </div>
  </div>
...
-->
  <script type="text/javascript" src="<?= base_url(''); ?>/home/main.0cf8b554.js"></script>
</body>
